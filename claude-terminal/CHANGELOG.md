...
- **Supported architectures**: amd64, aarch64 (32-bit ARM removed due to lack of verified checksums)
...
- **Home Assistant CLI**: Pinned to version `5.1.0` with SHA256 verification (independently verified against release assets)
...
- **GitHub CLI**: Pinned to version `2.93.0` with SHA256 verification (independently verified against release assets)
...
- **Placeholder checksums removed**: Removed empty-input SHA256 hashes (`e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`) for unsupported architectures (armv7, armhf, i386)
